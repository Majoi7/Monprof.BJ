 ...
 * - Cette page est intégrée dans app.jsx et n'est pas directement accessible depuis les autres composants.
 * - Si tu veux l'utiliser ailleurs, Jehovaly, tu dois l'importer explicitement depuis ce fichier.
 * - Elle propose :
 *   - Un formulaire pour saisir le nouveau mot de passe et sa confirmation
 *   - Une visualisation de la force du mot de passe
 *   - Des exigences détaillées pour créer un mot de passe sécurisé
 *   - Une animation d'orbes énergétiques et de blobs pour l'effet visuel
...
export default function ResetPasswordPage() {
  ...
  // Génération aléatoire d'orbes énergétiques pour l'effet visuel
  useEffect(() => {
  ...
  const handleSubmit = () => {
    setIsSuccess(true);
    // Ici tu pourrais ajouter la logique pour envoyer le mot de passe au backend
  };
  ...
  return (
    <div className="reset-page-container">
      ...
      <div className="reset-container">
        {/* Blobs de fond pour l'effet visuel */}

 ...
 * Permet à un utilisateur de créer un compte sur la plateforme.
 * 
 * Fonctionnalités :
 * - Saisie du nom complet, email, mot de passe et confirmation de mot de passe
 * - Affichage/Masquage des mots de passe
 * - Envoi du formulaire d'inscription
 * - Lien vers la page de connexion si l'utilisateur possède déjà un compte
 */
...
export default function SignupPage() {
  ...
  const handleSubmit = (e) => {
    ...
    // Ici on pourrais appeler une API pour créer le compte
  };

 ...
 * Inclut des effets visuels animés (ripples et blobs) pour améliorer l'expérience.
 */
export default function ForgotPasswordPage() {
    ...
    // État pour gérer les "ripples" animés en arrière-plan
    const [ripples, setRipples] = useState([]);

    // Initialisation des ripples avec des positions, délais et durées aléatoires
    useEffect(() => {
    ...
    // Réinitialisation automatique du message de succès après 3 secondes
    useEffect(() => {
        let timer;
        if (isSubmitted) {
